...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center pt-24 pb-12 px-6 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex-1 flex flex-col items-center justify-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="glass p-8 sm:p-12 md:p-20 rounded-[32px] w-full text-center"
        >
          ...
          <div className="text-lg sm:text-xl md:text-2xl font-mono text-primary mb-10 h-8">
            <Typewriter
              options={{
                strings: [
                  'I am a Data Analyst',
